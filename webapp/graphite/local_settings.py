...
STORAGE_DIR = '/mnt/data1/carbon_storage'
...
WHISPER_DIR = '/mnt/data1/carbon_storage/whisper'
RRD_DIR = '/opt/graphite/storage/rrd'
DATA_DIRS = [WHISPER_DIR, RRD_DIR] # Default: set from the above variables
LOG_DIR = os.path.join (PREFIX, 'log')
INDEX_FILE = os.path.join (PREFIX, 'index')  # Search index file
...
DATABASES = {
    'default': {
        'NAME': os.path.join (PREFIX, 'storage/graphite.db'),
